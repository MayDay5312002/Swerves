...
public class BestScoreScript
{
    public static bool BestScoreWrite(){
        ...
        try{
            ...
            if(temp < GameManagerScript.manager.time){
                ...
                writer.Close();
                writerEnc = new StreamWriter(@"Swerve_Data/Managed/escor.txt", false);//In Unity Editor: @"Assets/makuha/escor.txt";
    ...
    public static string BestScoreRead(){
        ...
        try{
            ...
            File.Delete(@"Swerve_Data/Managed/escor.txt");//In Unity Editor: @"Assets/makuha/escor.txt";
            return "0";
    ...
    public static string EncryptionBypass(){
        try{
            StreamReader reader = new StreamReader(@"Swerve_Data/Managed/escor.txt");//In Unity Editor: @"Assets/makuha/escor.txt";
